...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::delete('/folders/{task_id}/tasks/', 'TaskController@destroy')->name('tasks.destroy');
    // Route::delete('/folders/{id}/tasks/{task_id}', 'TaskController@destroy')->name('tasks.destroy');
    ...
    Route::delete('/folders/{folder}/folders', 'FolderController@destroy')->name('folders.destroy');
});
